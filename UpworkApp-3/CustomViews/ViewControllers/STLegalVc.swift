...
class STLegalVc: UIViewController {
    
    var tableView = UITableView()
    
    var rowData: [Model] = [Model(image: "doc.text.fill", name: "Terms of Service"),
                            Model(image: "newspaper.fill", name: "Privacy Policy")
    ]
...
extension STLegalVc: UITableViewDataSource, UITableViewDelegate {
