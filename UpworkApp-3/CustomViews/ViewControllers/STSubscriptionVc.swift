...
class STSubscriptionVc: UIViewController {
    
    var tableView = UITableView()
    
    var rowData: [Model] = [Model(image: "star.fill", name: "Upgrade to Pro"),
                            Model(image: "arrow.uturn.left.square.fill", name: "Restore Purchase")
    ]
...
extension STSubscriptionVc: UITableViewDataSource, UITableViewDelegate {
